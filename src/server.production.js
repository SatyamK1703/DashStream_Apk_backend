...
// PERFORMANCE OPTIMIZATION: Import MongoDB monitoring
import mongoMonitoring from "./utils/mongoMonitoring.js";
...
// PERFORMANCE OPTIMIZATION: MongoDB performance monitoring endpoint
app.get("/api/performance", async (req, res) => {
  try {
    const performanceStats = mongoMonitoring.getPerformanceStats();
    const healthCheck = await mongoMonitoring.checkDatabaseHealth();
    const recommendations = mongoMonitoring.getOptimizationRecommendations();
...
const connectDB = async () => {
  try {
    ...
    // PERFORMANCE OPTIMIZATION: Initialize MongoDB monitoring
    await mongoMonitoring.initialize();
