 ...
 */
export const createSendToken = (user, statusCode, res, message = 'Authentication successful') => {
...
export const checkResourceOwnership = (userField = 'user') => {
  return asyncHandler(async (req, res, next) => {
    ...
    const resourceUserId = req.params.userId || req.body[userField] || req.resource?.[userField];
